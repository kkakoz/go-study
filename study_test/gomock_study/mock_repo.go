...
// Package mock_gomock_study is a generated GoMock package.
...
func (m *MockRepository) Create(key, value string) error {
	m.ctrl.T.Helper()
...
func (m *MockRepository) GetInt(key string) int {
	m.ctrl.T.Helper()
...
func (mr *MockRepositoryMockRecorder) GetInt(key interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetInt", reflect.TypeOf((*MockRepository)(nil).GetInt), key)
}
...
func (m *MockRepository) Update(key, value string) error {
	m.ctrl.T.Helper()
