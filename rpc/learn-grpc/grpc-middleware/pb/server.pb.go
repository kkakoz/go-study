...
var fileDescriptor_ad098daeda4239f7 = []byte{
	...
	0xca, 0x20, 0x1c, 0x23, 0x2b, 0x2e, 0x1e, 0x88, 0xba, 0x60, 0xb0, 0x15, 0x42, 0x5a, 0x5c, 0xac,
	0x41, 0xf9, 0xa5, 0x25, 0xa9, 0x42, 0x7c, 0x7a, 0x28, 0x96, 0x48, 0xf1, 0xeb, 0xa1, 0x9a, 0xa7,
	0xc4, 0xe0, 0xc4, 0x1e, 0xc5, 0xaa, 0xa7, 0x6f, 0x5d, 0x90, 0x94, 0xc4, 0x06, 0x76, 0x98, 0x31,
	0x20, 0x00, 0x00, 0xff, 0xff, 0x76, 0x5b, 0xda, 0x10, 0xa8, 0x00, 0x00, 0x00,
}
...
func (c *simpleServerClient) Route(ctx context.Context, in *SimpleRequest, opts ...grpc.CallOption) (*SimpleResponse, error) {
	out := new(SimpleResponse)
	err := c.cc.Invoke(ctx, "/SimpleServer/Route", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _SimpleServer_Route_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SimpleRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SimpleServerServer).Route(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/SimpleServer/Route",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SimpleServerServer).Route(ctx, req.(*SimpleRequest))
	}
...
var _SimpleServer_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Route",
			Handler:    _SimpleServer_Route_Handler,
		},
	},
