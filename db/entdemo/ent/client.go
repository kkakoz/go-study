...
import (
	"context"
	"fmt"
	education2 "learn-go/db/entdemo/ent/education"
	institution2 "learn-go/db/entdemo/ent/institution"
	"learn-go/db/entdemo/ent/migrate"
	"log"
...
func (c *EducationClient) DeleteOneID(id int) *EducationDeleteOne {
	builder := c.Delete().Where(education2.ID(id))
...
func (c *EducationClient) Get(ctx context.Context, id int) (*Education, error) {
	return c.Query().Where(education2.ID(id)).Only(ctx)
}
...
func (c *EducationClient) QueryInstitution(e *Education) *InstitutionQuery {
	...
	query.path = func(ctx context.Context) (fromV *sql.Selector, _ error) {
		...
		step := sqlgraph.NewStep(
			sqlgraph.From(education2.Table, education2.FieldID, id),
			sqlgraph.To(institution2.Table, institution2.FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, education2.InstitutionTable, education2.InstitutionColumn),
		)
...
func (c *InstitutionClient) DeleteOneID(id int) *InstitutionDeleteOne {
	builder := c.Delete().Where(institution2.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
...
func (c *InstitutionClient) Get(ctx context.Context, id int) (*Institution, error) {
	return c.Query().Where(institution2.ID(id)).Only(ctx)
}
