...
func HasInstitution() predicate.Education {
	return predicate.Education(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(InstitutionTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, InstitutionTable, InstitutionColumn),
		)
...
func HasInstitutionWith(preds ...predicate.Institution) predicate.Education {
	return predicate.Education(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
